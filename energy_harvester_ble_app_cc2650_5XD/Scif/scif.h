/** \mainpage Driver Overview
  ...
  * - <b>Created</b>:          2020-09-14 11:50:07.365
  * - <b>Computer</b>:         DESKTOP-1QJ86A9
  * - <b>User</b>:             bhara
  *
...
/// compHandle: 
#define SCIF_COMP_HANDLE_ARRAY_SIZE 5
...
typedef struct {
    ...
    uint16_t TimeOutHighArray[5]; ///< 
    uint16_t TimeOutLow;          ///< Pulse width for 10 pulses
    uint16_t TimeOutLowArray[5];  ///< 
